...
class SetReviewWarningCommand extends AbstractServerDiscordCommand
{
    ...
    {
        return 'set-review-warning';
    }

    public function getDescription(): string
    {
        return 'Défini le nombre de commentaire minimum pour éviter le warning sur une offre';
    }
    ...
    public function serverExecute(Interaction $interaction): ?PromiseInterface
    {
        ...
        $this->configBusiness->set('review_warning', $minReviews);
